...
<div class="container">
    ...
    <div class="row justify-content-center mt-4">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">ipNetToMediaType Table</div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="type" name="type">
                            ...
                            <option value="{{ route('tables/ipNetToMediaNetAddress') }}">ipNetToMediaNetAddress</option>
                            <option value="{{ route('tables/ipNetToMediaType') }}">ipNetToMediaType</option>
                        </select>
                    </div>
                    <table class="table">
                        <thead>
